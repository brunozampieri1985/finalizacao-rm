...
import { getMaterialOptions, Rodabase } from "@/lib/features/calculo-marmore";

export function RodabaseForm() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button onClick={() => setOpen(true)}>+ Rodabase</Button>
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
